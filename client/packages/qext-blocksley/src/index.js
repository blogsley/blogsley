...
const extendQuasarConf = function (conf) {
  ...
  conf.boot.push('~@blogsley/quasar-app-extension-blocksley/src/boot/blocksley.js')
  conf.boot.push('~@blogsley/quasar-app-extension-blocksley/src/boot/resizable.js')
  conf.boot.push('~@blogsley/quasar-app-extension-blocksley/src/boot/draggable.js')
  conf.boot.push('~@blogsley/quasar-app-extension-blocksley/src/boot/clickaway.js')
  
  conf.build.vueCompiler = true
  // make sure boot file & component transpiles
  conf.build.transpileDependencies.push(/@blogsley[\\/]quasar-app-extension-blocksley[\\/]src[\\/]/)
  ...
  conf.css.push('~@blogsley/blocksley/src/css/blocksley.styl')
  ...
  api.extendWebpack((cfg, { isClient, isServer }, api) => {
    ...
    */
    ...
    cfg.resolve.alias = {
      ...
      // 'blocksley': '@blogsley/blocksley/src'
      // 'blocksley': path.resolve(api.appDir, './node_modules/@blogsley/quasar-app-extension-blocksley/src/component/'),
